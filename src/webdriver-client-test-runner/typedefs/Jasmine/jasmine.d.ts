...
declare namespace jasmine {
    ...
    interface Block {
        ...
        new (env: Env, func: SpecFunction, spec: SpecResult): any;

        execute(onComplete: () => void): void;
    }

    interface WaitsBlock extends Block {
        new (env: Env, timeout: number, spec: SpecResult): any;
    }

    interface WaitsForBlock extends Block {
        new (env: Env, timeout: number, latchFunction: SpecFunction, message: string, spec: SpecResult): any;
    }
    ...
    interface Env {
        ...
        it(description: string, func: () => void): SpecResult;
        ...
        specFilter(spec: SpecResult): boolean;
